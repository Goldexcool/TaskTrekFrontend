  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-blue-400",
  {
    variants: {
      variant: {
        ...
        outline: "border border-gray-300 bg-transparent hover:bg-black-100 hover:text-gray-900 dark:border-gray-700 dark:hover:bg-black-800 dark:hover:text-gray-50",
        secondary: "bg-black-100 text-gray-900 hover:bg-black-200 dark:bg-black-800 dark:text-gray-50 dark:hover:bg-black-700",
        ghost: "bg-transparent hover:bg-black-100 hover:text-gray-900 dark:hover:bg-black-800 dark:hover:text-gray-50",
        link: "text-blue-600 underline-offset-4 hover:underline dark:text-blue-400",
        glass: "bg-white/20 backdrop-blur-sm border border-white/30 hover:bg-white/30 text-gray-900 dark:text-white dark:border-gray-800/30 dark:bg-black-900/20 dark:hover:bg-black-900/30",
